...
// childhoodHomeAnswer === childhoodHomeAnswer.toLowerCase; 
// or you can write the code as var blah= prompt('something").toLowerCase(); but cancelling the prompt can cause the program to crash
